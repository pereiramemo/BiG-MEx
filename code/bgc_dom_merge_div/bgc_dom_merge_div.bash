...
--font_size plot NUM        font size in rarefaction plot (default 10). R parameter
--font_tree_size NUM        plot font size in tree plot (default 2). R parameter
...
--nslots NUM                number of slots (default 2). mmseqs cluster parameter
--verbose NUM               run verbosely (default f)
--overwrite t|t             overwrite current directory (default f)

<input directory 1>,<input directory 2>,<input directory 3> is a comma-separated list of output directories generated by bgc_dom_div using the amp or meta modes
