...
### 3. bgc_class_models
This module is based on the [bgcpred](git@github.com:pereiramemo/bgcpred.git) R package, which includes a library of BGC class abundance models. Based on the domain profile generated by bgc_dom_annot, this module computes the BGC class abundance profile.
