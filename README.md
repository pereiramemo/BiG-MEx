...
### 3. bgc_class_models
This module is based on the [bgcpred R package](git@github.com:pereiramemo/bgcpred.git), which includes a library of BGC class abundance models. Based on the domain profiles generated by bgc_dom_annot, this module computes the BGC class abundance profile.
