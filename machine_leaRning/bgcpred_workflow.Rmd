...
Next, we will check MLR assumptions through the visualization of different plots.
...
3. Linearity
Lastly, we check if there is a linear relationship between the predictor and response variables. To do this, we will plot the residuals vs. the predictor variables. Given that we have to create a plot for each domain, we only show the plots for the nrps domains. 
